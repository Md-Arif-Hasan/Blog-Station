...
exports.sendJsResponse = (req, res, statusCode, data) => res.status(statusCode).send(data);

exports.sendXmlResponse = (req, res, statusCode, data) => res.status(statusCode).send(js2xmlparser.parse('data', data));

exports.sendHtmlResponse = (req, res, statusCode, data) => res.status(statusCode).send(js2Html(data));
...
exports.sendResponse = (req, res, statusCode, data) => {
    ...
    return this.sendJsResponse(req, res, statusCode, data);
};
